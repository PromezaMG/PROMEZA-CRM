...
const Topbar = ({
  ...
  const searchResults = React.useMemo(() => {
    ...
    const searchStrP = p => [p.first, p.last, (p.emails || []).map(e => e.value || "").concat([p.email || ""]).join(" "), (p.phones || []).map(ph => ph.value || "").concat([p.phone || ""]).join(" "), p.city, p.county, p.state, p.country, (p.roles || []).join(" "), p.role, (p.tags || []).join(" ")].map(norm).join(" ");
    const matchP = p => {
      const s = searchStrP(p);
      // Exact phrase first, then all-words fallback
      return s.includes(q) || allWords(s);
    };
    const searchStrE = e => [e.name, (e.emails || []).map(em => em.value || "").concat([e.email || ""]).join(" "), e.city, e.county, e.state, e.country, (e.phones || []).map(ph => ph.value || "").concat([e.phone || ""]).join(" "), (e.tags || []).join(" ")].map(norm).join(" ");
    const matchE = e => {
  ...
  }, "Entidades \xB7 ", searchResults.entities.length), searchResults.entities.map(e => /*#__PURE__*/React.createElement("div", {
    key: e.id,
    style: {
      padding: "9px 16px",
      display: "flex",
  ...
  }, (t.types || {})[e.type] || e.type)))), searchResults.projects.length > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "8px 16px 4px",
      fontSize: 10,
      fontWeight: 700,
...
const MapPage = ({
  ...
  const items = [...entitiesFiltered.map(e => ({
    kind: "entity",
    id: e.id,
    name: e.name,
  ...
  }, es ? "Sin ubicaciones" : "No locations"), items.map(it => /*#__PURE__*/React.createElement("div", {
    key: it.kind + it.id,
    className: "row",
    onClick: () => go({
      name: it.kind,
  ...
  }, it.sub || "—"))))), sideTab === "condados" && /*#__PURE__*/React.createElement("div", {
    className: "list",
    style: {
      padding: "8px 0"
    }
...
const PersonasList = ({
  ...
  const rows = React.useMemo(() => data.personas.filter(p => {
    ...
    return true;
  }).sort((a, b) => ((x,y)=>!x&&!y?0:!x?1:!y?-1:window.nameCmp(x,y))(fullName(a),fullName(b))), [data.personas, role, country, stateFilter, status, stageFilter, langFilter, city, countyFilter, zip, tagFilter, emailFilter, phoneFilter, q, globalQ]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  React.useEffect(() => {
    setPage(0);
  }, [role, country, stateFilter, status, stageFilter, langFilter, city, countyFilter, zip, tagFilter, emailFilter, phoneFilter, q, globalQ]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  const doExportCSV = () => {
    ...
    const csvRows = rows.map(p => ({
      ...
      nombre: p.first,
      apellido: p.last,
      cargo: p.roles ? p.roles.map(r => t.roles[r] || r).join(", ") : p.role === "otro" ? p.roleOther || "Otro" : t.roles[p.role] || p.role,
      email: p.email,
      telefono: p.phone,
      direccion: p.address,
      zip: p.zip,
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "btn",
    onClick: doExportCSV,
    title: lang === "es" ? `Exportar ${rows.length} de ${data.personas.length} personas` : `Export ${rows.length} of ${data.personas.length} people`
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "download"
  }), " ", t.common.exportCSV, rows.length < data.personas.length ? ` (${rows.length})` : ""), /*#__PURE__*/React.createElement("button", {
    className: "btn",
    ...
    name: "plus"
  }), " ", t.nav.newPerson))), showFilters && /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      marginBottom: 12,
      padding: "16px 20px"
    ...
    className: "role-pill"
  }, p.roles ? p.roles.map(r => t.roles[r] || r).join(" · ") : p.role === "otro" ? p.roleOther || t.roles.otro : t.roles[p.role] || p.role)), /*#__PURE__*/React.createElement("td", null, !p.entities || p.entities.length === 0 ? /*#__PURE__*/React.createElement("span", {
    className: "muted"
  }, "\u2014") : /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
...
const EntitiesList = ({
  ...
  React.useEffect(() => {
    setPage(0);
  }, [type, country, status, city, stateFilter, countyFilter, zip, tagFilter, emailFilter, phoneFilter, dayFilter, q]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "btn",
    onClick: doExportCSV,
    title: lang === "es" ? `Exportar ${rows.length} de ${data.entities.length} entidades` : `Export ${rows.length} of ${data.entities.length} entities`
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "download"
  }), " ", t.common.exportCSV, rows.length < data.entities.length ? ` (${rows.length})` : ""), /*#__PURE__*/React.createElement("button", {
    className: "btn",
    onClick: () => setShowImport(true)
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "upload"
...
const PersonProfile = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "#", window.getUID ? window.getUID(p.id) : p.id)), /*#__PURE__*/React.createElement("div", {
    className: "sub"
  }, /*#__PURE__*/React.createElement("span", {
    className: "role-pill"
    ...
    name: "calendar",
    size: 12
  }), " ", daysSinceContact === 0 ? lang === "es" ? "contactado hoy" : "contacted today" : lang === "es" ? `${daysSinceContact}d sin contacto` : `${daysSinceContact}d no contact`), p.tags && p.tags.map(tg => /*#__PURE__*/React.createElement("span", {
    key: tg,
    className: "tag-chip"
    ...
    className: "kv"
  }, /*#__PURE__*/React.createElement("dt", null, "Email"), /*#__PURE__*/React.createElement("dd", null, p.email || /*#__PURE__*/React.createElement("span", {
    className: "muted"
  }, "\u2014")), /*#__PURE__*/React.createElement("dt", null, lang === "es" ? "Teléfono" : "Phone"), /*#__PURE__*/React.createElement("dd", null, p.phone || /*#__PURE__*/React.createElement("span", {
    className: "muted"
    ...
    className: "muted"
  }, "\u2014")), /*#__PURE__*/React.createElement("dt", null, t.common.language), /*#__PURE__*/React.createElement("dd", null, p.language === "en" ? "English" : "Español"), /*#__PURE__*/React.createElement("dt", null, t.common.tags), /*#__PURE__*/React.createElement("dd", null, p.tags && p.tags.length > 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 4,
      flexWrap: "wrap"
...
const EntityProfile = ({
  ...
  const availablePersons = data.personas.filter(p => !linkedPersonIds.has(p.id)).sort((a, b) => ((x,y)=>!x&&!y?0:!x?1:!y?-1:window.nameCmp(x,y))(fullName(a),fullName(b)));
  const doLinkPerson = () => {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    name: "users"
  }), " ", linkedPeople.length, " ", t.common.relatedPersonas.toLowerCase()), e.size && /*#__PURE__*/React.createElement("span", null, e.size.toLocaleString(), " ", t.common.members), (e.tags || []).map(tg => /*#__PURE__*/React.createElement("span", {
    key: tg,
    className: "tag-chip"
  }, tg))), /*#__PURE__*/React.createElement("div", {
    className: "vid",
...
const DuplicatesPage = ({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    name: "search"
  }), " ", lang === "es" ? "Escanear base completa" : "Scan full database"))), active.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      padding: "48px 24px",
      textAlign: "center"
...
const SettingsModal = ({
    ...
    reader.onload = e => {
      try {
        ...
        if (!parsed.personas || !parsed.entities) {
          setBackupMsg({
            type: "err",
            text: lang === "es" ? "Archivo inválido: faltan personas o entidades" : "Invalid file: missing personas or entities"
          });
          return;
        }
        if (window.confirm(lang === "es" ? "¿Restaurar estos datos? Se reemplazarán TODOS los datos actuales." : "Restore this data? ALL current data will be replaced.")) {
          ...
          setBackupMsg({
            type: "ok",
            text: lang === "es" ? `✓ Datos restaurados: ${parsed.personas.length} personas, ${parsed.entities.length} entidades` : `✓ Data restored: ${parsed.personas.length} people, ${parsed.entities.length} entities`
          });
        }
      } catch {
        setBackupMsg({
  ...
  const doSync = async () => {
    ...
    try {
      ...
      setSyncStatus("✓ " + (st.syncDone || "Sync completed") + " — " + result.personas.created + " personas creadas, " + result.personas.updated + " actualizadas · " + result.entities.created + " entidades creadas, " + result.entities.updated + " actualizadas");
    } catch (err) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, st.title || "Configuración"), /*#__PURE__*/React.createElement("button", {
    className: "icon-btn",
    onClick: onClose
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "x"
  ...
  }, "PROMEZA CRM \xB7 app0MYHVyhTYFsDqV"))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "var(--bg-soft)",
      borderRadius: 8,
      padding: "10px 14px",
  ...
  }, st.lastSync || "Última sync:", " ", /*#__PURE__*/React.createElement("strong", null, lastSyncFmt)), syncStatus && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 12,
      padding: "10px 14px",
      borderRadius: 8,
    ...
    name: "sync"
  }), " ", syncing ? "Enviando…" : "⬆ Enviar mis datos a Airtable"), /*#__PURE__*/React.createElement("button", {
    className: "btn",
    style: {
      width: "100%",
      fontWeight: 600
  ...
  }, "\u2B07 Recibir cambios de Airtable"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: "var(--ink-4)",
      lineHeight: 1.5,
  ...
  }, /*#__PURE__*/React.createElement("strong", null, "\u2B06 Enviar"), " = sube TUS datos a Airtable (hazlo desde la MacBook).", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "\u2B07 Recibir"), " = descarga lo que hay en Airtable (hazlo desde Windows)."))), tab === "emailjs" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      background: "var(--accent-50)",
      border: "1px solid var(--accent-100)",
      borderRadius: 8,
  ...
  }, /*#__PURE__*/React.createElement("strong", null, lang === "es" ? "EmailJS se usa para recuperar contraseña." : "EmailJS is used for password recovery."), " ", lang === "es" ? "Crea una cuenta gratis en" : "Create a free account at", " ", /*#__PURE__*/React.createElement("a", {
  ...
  }, "Microsoft Entra ID \xB7 AES-256"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "var(--ink-3)"
    }
  }, "Auto-cierre: 1 hora de inactividad \xB7 Solo @promeza.com"))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 600,
      fontSize: 14,
      marginBottom: 6
  ...
  }, "Deja vac\xEDo para permitir cualquier cuenta @promeza.com. Si escribes correos espec\xEDficos, solo ellos podr\xE1n entrar."), /*#__PURE__*/React.createElement("div", {
    className: "field",
    style: {
      marginBottom: 4
    }
  ...
  }, "Un correo por l\xEDnea o separados por coma. Se guarda al presionar \"Guardar configuraci\xF3n\"."), /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 600,
      fontSize: 14,
      marginBottom: 8,
  ...
  }, "Sin registros a\xFAn") : /*#__PURE__*/React.createElement("div", {
    style: {
      maxHeight: 260,
      overflowY: "auto",
      border: "1px solid var(--line)",
  ...
  }, ["Fecha", "Usuario", "Acción", "Dispositivo", "Localidad"].map(h => /*#__PURE__*/React.createElement("th", {
    key: h,
    style: {
      padding: "6px 10px",
      textAlign: "left",
    ...
    name: "log-out"
  }), " Cerrar esta sesi\xF3n"))), tab === "account" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      background: "var(--bg-soft)",
      borderRadius: 10,
      padding: "14px 16px",
    ...
    name: "log-out"
  }), " ", st.logout || "Cerrar sesión")), tab === "backup" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 20
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, lang === "es" ? "Descarga una copia completa de todos tus datos como archivo JSON. Guárdala en un lugar seguro." : "Download a complete copy of all your data as a JSON file. Keep it in a safe place."), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "var(--bg-soft)",
      borderRadius: 8,
      padding: "10px 14px",
  ...
  }, data.personas.length, " ", lang === "es" ? "personas" : "people", " \xB7 ", data.entities.length, " ", lang === "es" ? "entidades" : "entities", " \xB7 ", (data.projects || []).length, " ", lang === "es" ? "proyectos" : "projects"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary",
    onClick: doExport
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "download"
  ...
  }, "\u26A0 ", lang === "es" ? "Esto reemplazará TODOS los datos actuales." : "This will replace ALL current data."), /*#__PURE__*/React.createElement("label", {
    className: "btn",
    style: {
      cursor: "pointer"
    }
    ...
    name: "upload"
  }), " ", lang === "es" ? "Seleccionar archivo de respaldo…" : "Select backup file…", /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: ".json",
    style: {
      display: "none"
    ...
    name: "check"
  }), " ", st.saved || "Guardado") : st.save || "Guardar configuración"))));
};
...
const RemindersModal = ({
  ...
  }, "\uD83C\uDF82 ", lang === "es" ? "Cumpleaños hoy" : "Birthdays today"), birthdaysToday.map(p => /*#__PURE__*/React.createElement("div", {
    key: p.id,
    className: "hover-row",
    onClick: () => {
      go({
  ...
  }, "\uD83C\uDF82")))), overdueTasks.length > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
      fontSize: 13,
      color: "#ef4444",
  ...
  }, "\u26A0 ", overdueTasks.length, " ", lang === "es" ? "tarea" + (overdueTasks.length !== 1 ? "s vencidas" : " vencida") : "overdue task" + (overdueTasks.length !== 1 ? "s" : "")), overdueTasks.slice(0, 5).map(tk => /*#__PURE__*/React.createElement("div", {
    key: tk.id,
    style: {
      display: "flex",
      alignItems: "center",
  ...
  }, "+", overdueTasks.length - 5, " ", lang === "es" ? "más" : "more")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      justifyContent: "flex-end",
...
class ViewErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.error) {
      ...
      }, "Algo sali\xF3 mal en esta vista"), /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: 12,
          color: "var(--ink-4)",
          maxWidth: 400
...
const App = () => {
  ...
  const syncFromAirtable = () => {
    ...
    window.AIRTABLE.loadData().then(atData => {
      if (atData && (atData.personas.length > 0 || atData.entities.length > 0)) {
        ...
        setAtSyncMsg({
          type: "ok",
          text: "↓ Airtable: " + atData.personas.length + " personas · " + atData.entities.length + " entidades"
        });
      } else if (atData) {
        setAtSyncMsg({
          type: "warn",
          text: "⚠ Airtable vacío — haz 'Sincronizar todo' desde la MacBook primero"
        });
      } else {
        setAtSyncMsg({
          type: "err",
          text: "✗ No se pudo leer Airtable — revisa conexión"
        });
      }
    }).catch(e => {
      setAtSyncMsg({
        type: "err",
        text: "✗ Error Airtable: " + e.message
      });
  ...
  const forcePullFromAirtable = () => {
    ...
    window.AIRTABLE.loadData().then(atData => {
      if (atData && (atData.personas.length > 0 || atData.entities.length > 0)) {
        ...
        setAtSyncMsg({
          type: "ok",
          text: "✓ Recibido: " + atData.personas.length + " personas · " + atData.entities.length + " entidades"
        });
      } else if (atData) {
        setAtSyncMsg({
          type: "warn",
          text: "⚠ Airtable no tiene datos — primero sincroniza desde la MacBook"
        });
      } else {
        setAtSyncMsg({
          type: "err",
          text: "✗ No se pudo conectar a Airtable"
        });
      }
    }).catch(e => {
      setAtSyncMsg({
  ...
  useEffect(() => {
    const initData = async () => {
      ...
      if (!localStorage.getItem('promeza_cleanslate_v150')) {
        try {
          ...
          if (at && (at.personas || []).length > 200) {
            ...
            localStorage.setItem('promeza_cleanslate_v150', '1');
            try {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onLogout: () => {
      clearSession();
      sessionStorage.removeItem(window.CryptoUtils?.SESSION_CRYPTO_KEY || "promeza_sk");
      if (window.AIRTABLE) window.AIRTABLE.logAccess(userEmail, "Cierre de sesión");
      setUserEmail(null);
    },
    userEmail: userEmail,
    data: data,
