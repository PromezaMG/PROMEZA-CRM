...
const ACCESOS = [
  {
    ...
    color: "#4f46e5",
    items: [
      { ic: "📝", tt: "AidaForm", ds: "Formularios de eventos y solicitudes", u: "https://my.aidaform.com/" },
      { ic: "📧", tt: "GoDaddy Email Marketing", ds: "Correos masivos y campañas", u: "https://email.marketing.godaddy.com/" },
      { ic: "📨", tt: "Outlook — Correo", ds: "Bandeja de entrada de Microsoft", u: "https://outlook.cloud.microsoft/mail/inbox" },
    ],
  },
  {
    grupo: "Flywheel",
    color: "#2b7a9e",
    items: [
      { ic: "🎬", tt: "Flywheel — Panel de equipo", ds: "Administración del equipo (themoviescreener)", u: "https://themoviescreener.com/flywheel/_admin/team" },
      { ic: "📊", tt: "Flywheel — Registros Unificados", ds: "Hoja de cálculo con los registros", u: "https://docs.google.com/spreadsheets/d/1DKgBrv-eZb8SN4a6RCsiSE8OQ2KHoViqv8yqM4MHKRo/edit" },
    ],
  },
  {
    ...
    color: "#b91c1c",
    items: [
      { ic: "📊", tt: "Encuentro Especial — AMEA", ds: "Registros (español)", u: "https://docs.google.com/spreadsheets/d/10sgVI67RCcstRsKsJDhQpGMSSMZH4upZQjepIPci-rQ/edit" },
      { ic: "📊", tt: "Encuentro Especial — AMEA (Inglés)", ds: "Registros en inglés", u: "https://docs.google.com/spreadsheets/d/1ChlXUm9zGwcNKeqaBZ5bq1ATCcCjHAktRNr_LHztHns/edit" },
      { ic: "📊", tt: "Encuentro Especial — AMEA / Virtual", ds: "Registros del evento virtual", u: "https://docs.google.com/spreadsheets/d/1K67hs08cbhH4Fy5-JgLxlsM30WklsJaBfBrye8ERd40/edit" },
    ],
  },
  {
    ...
    color: "#7c3aed",
    items: [
      { ic: "📋", tt: "Pastores Invitados — Mottesi", ds: "Lista de pastores del evento (Google Sheet)", u: "https://docs.google.com/spreadsheets/d/1K2LOBGQMx5Jn2ih1QItDXT7K6HVtStVtaCQmS3f-wlA/edit" },
    ],
  },
  {
    ...
    color: "#22a06b",
    items: [
      { ic: "📁", tt: "PROMEZA", ds: "Carpeta principal en Drive", u: "https://drive.google.com/drive/folders/1CSoDyHpgK2cOqwI08qJyHPV8XrxFs3Ut?usp=drive_link" },
      { ic: "🎵", tt: "“Fui Hallado” — Daniel Olalla", ds: "Materiales del proyecto", u: "https://drive.google.com/drive/folders/13QALFFtiNypRftfIbyjP27F-4xWM_Bih?usp=drive_link" },
      { ic: "📁", tt: "Carpeta de Drive (3)", ds: "Enlace compartido", u: "https://drive.google.com/drive/folders/1i3A8bWsdNPDx9F9fJcJwQGmrLNeoZ1vE?usp=drive_link" },
    ],
  },
];

const AccesosView = ({ lang }) => {
  const es = lang !== "en";
  return (
    <div style={{ maxWidth: 900, margin: "0 auto" }}>
      <div className="page-head" style={{ marginBottom: 18 }}>
        <div>
          <h1 className="page-title">{es ? "Accesos" : "Quick Links"}</h1>
          <p className="page-sub">
            {es ? "Todos tus sistemas y carpetas en un solo lugar. Toca una tarjeta para abrir en una pestaña nueva." : "All your systems and folders in one place."}
          </p>
        </div>
      </div>
      {ACCESOS.map((sec) => (
        <div key={sec.grupo} style={{ marginBottom: 22 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, margin: "0 0 10px" }}>
            <span style={{ width: 9, height: 9, borderRadius: "50%", background: sec.color, flex: "none" }} />
            <h3 style={{ margin: 0, fontSize: 14 }}>{sec.grupo}</h3>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: 11 }}>
            {sec.items.map((it) => (
              <a key={it.tt} href={it.u} target="_blank" rel="noopener noreferrer"
                 style={{ display: "flex", gap: 12, alignItems: "flex-start", textDecoration: "none",
                          background: "var(--bg-card, #fff)", border: "1px solid var(--line)", borderRadius: 14,
                          padding: "13px 14px", color: "var(--ink)", boxShadow: "0 1px 2px rgba(0,0,0,.04)" }}>
                <span style={{ width: 40, height: 40, borderRadius: 11, flex: "none", display: "grid",
                               placeItems: "center", fontSize: 19, background: sec.color + "1a" }}>{it.ic}</span>
                <span style={{ minWidth: 0, flex: 1 }}>
                  <span style={{ display: "block", fontWeight: 700, fontSize: 14 }}>{it.tt}</span>
                  <span className="muted" style={{ display: "block", fontSize: 12.5, marginTop: 2 }}>{it.ds}</span>
                </span>
                <span style={{ color: "var(--ink-3)", flex: "none", alignSelf: "center" }}>↗</span>
              </a>
            ))}
          </div>
        </div>
